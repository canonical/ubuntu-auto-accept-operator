The easiest way to report a security issue is through a [GitHub Private Security Report](https://github.com/canonical/ubuntu-auto-accept-operator/security/advisories/new)
