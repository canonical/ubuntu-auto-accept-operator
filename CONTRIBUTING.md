...
- Generally, before developing enhancements to this charm, you should consider [opening an issue
  ](https://github.com/canonical/ubuntu-auto-accept-operator/issues) explaining your use case.
...
secret:<someuuid>
# now deploy
❯ juju deploy -- ./ubuntu-auto-accept_amd64.charm ubuntu-auto-accept
# Then allow access
❯ juju grant-secret lpuser_secret_id ubuntu-auto-accept
# glue the defined secret and the deployed charm together via config
❯ juju config ubuntu-auto-accept lpuser_secret_id=secret:<someuuid>

# To blast it away no matter the open half debugged state
❯ juju remove-application --no-prompt --force --no-wait ubuntu-auto-accept
```
